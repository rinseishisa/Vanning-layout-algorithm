...
CONTAINER_LENGTH_MM = 5900
CONTAINER_WIDTH_MM = 2350
CONTAINER_HEIGHT_MM = 2390
MAX_CONTAINER_WEIGHT_KG = 24000.0
MIN_FILL_RATE = 0.50
Y_CENTER_MM = CONTAINER_LENGTH_MM / 2.0
Y_DEVIATION_FULL_SCORE_MM = 590.0
Y_DEVIATION_LIMIT_MM = 1475.0
ROTATIONS = [0, 90]
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run container layout from generated items csv")
    parser.add_argument("--input", type=Path, default=Path("generated_items.csv"))
    parser.add_argument("--output", type=Path, default=Path("output_solution_spec.json"))
